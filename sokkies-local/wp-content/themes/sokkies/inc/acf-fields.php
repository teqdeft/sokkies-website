...
Het item is vanzelf gemarkeerd als "huidige pagina" wanneer de bezoeker op de gekoppelde pagina staat.',
			...
			/* ── Footer-inhoud ────────────────────────────────────────────────
			   Alles ONDER en NAAST de linkkolommen: de tekst bij het logo, de
			   keurmerken, de socials, het nieuwsbriefblok, de partnerlogo's,
			   de betaal- en verzendlogo's, de reviewblokken en de slotregel.
			   De linkkolommen zelf staan op het tabblad Footermenu hiernaast.

			   Overal geldt de vaste regel van dit thema: LEEG = de inhoud uit
			   het ontwerp. Wie niets invult ziet exact wat er nu staat. */
			array( 'key' => 'field_si_tab_footer', 'label' => 'Footer-inhoud', 'type' => 'tab' ),
			array(
				'key'          => 'field_si_fi_intro',
				'label'        => 'Tekst onder het logo',
				'name'         => 'footer_intro',
				'type'         => 'textarea',
				'rows'         => 3,
				'new_lines'    => '',
				'instructions' => 'Leeg = de tekst uit het ontwerp.',
			),
			array(
				'key'          => 'field_si_fi_certs_label',
				'label'        => 'Label bij de keurmerken',
				'name'         => 'footer_certs_label',
				'type'         => 'text',
				'instructions' => 'Leeg = "Gecertificeerd".',
			),
			array(
				'key'          => 'field_si_fi_certs',
				'label'        => 'Keurmerken',
				'name'         => 'footer_certs',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Keurmerk toevoegen',
				'instructions' => 'Leeg = OEKO-TEX en BSCI.',
				'sub_fields'   => array(
					array( 'key' => 'field_si_fi_cert_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail' ),
				),
			),
			array(
				'key'          => 'field_si_fi_socials',
				'label'        => 'Social media',
				'name'         => 'footer_socials',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Social toevoegen',
				'instructions' => 'Het icoon hoort bij het gekozen platform en zit in het thema. Leeg = LinkedIn, Facebook en Instagram.',
				'sub_fields'   => array(
					array(
						'key'     => 'field_si_fi_social_platform',
						'label'   => 'Platform',
						'name'    => 'platform',
						'type'    => 'select',
						'choices' => array(
					...
					array( 'key' => 'field_si_fi_social_url', 'label' => 'Adres', 'name' => 'url', 'type' => 'url' ),
				),
			),
			array(
				'key'          => 'field_si_fi_news_titel',
				'label'        => 'Nieuwsbrief — kop',
				'name'         => 'footer_news_titel',
				'type'         => 'text',
				'instructions' => 'Leeg = "Mis niets".',
			),
			array(
				'key'          => 'field_si_fi_news_tekst',
				'label'        => 'Nieuwsbrief — regel erboven',
				'name'         => 'footer_news_tekst',
				'type'         => 'text',
				'instructions' => 'Leeg = "Of schrijf je in voor de nieuwsbrief".',
			),
			array(
				'key'          => 'field_si_fi_partners_label',
				'label'        => 'Label bij de goede doelen',
				'name'         => 'footer_partners_label',
				'type'         => 'text',
				'instructions' => 'Leeg = "In samenwerking met".',
			),
			array(
				'key'          => 'field_si_fi_partners',
				'label'        => 'Goede doelen',
				'name'         => 'footer_partners',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Logo toevoegen',
				'instructions' => 'Leeg = One Tree Planted en Voedselbanken.',
				'sub_fields'   => array(
					array( 'key' => 'field_si_fi_partner_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail' ),
					array( 'key' => 'field_si_fi_partner_link', 'label' => 'Link', 'name' => 'link', 'type' => 'url', 'instructions' => 'Leeg = geen link.' ),
				),
			),
			array(
				'key'          => 'field_si_fi_pay_label',
				'label'        => 'Label bij de betaalmethoden',
				'name'         => 'footer_pay_label',
				'type'         => 'text',
				'instructions' => 'Leeg = "Betaal eenvoudig".',
			),
			array(
				'key'          => 'field_si_fi_pay',
				...
				'layout'       => 'table',
				'button_label' => 'Logo toevoegen',
				'instructions' => 'Leeg = de negen logo\'s uit het ontwerp.',
				'sub_fields'   => array(
					array( 'key' => 'field_si_fi_pay_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail' ),
				),
			),
			array(
				'key'          => 'field_si_fi_ship_label',
				'label'        => 'Label bij de verzendpartners',
				'name'         => 'footer_ship_label',
				'type'         => 'text',
				'instructions' => 'Leeg = "Onze verzendpartners".',
			),
			array(
				'key'          => 'field_si_fi_ship',
				'label'        => 'Verzendpartners',
				'name'         => 'footer_ship',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Logo toevoegen',
				'instructions' => 'Leeg = FedEx, PostNL, UPS, DPD en DHL.',
				'sub_fields'   => array(
					array( 'key' => 'field_si_fi_ship_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail' ),
				),
			),
			array(
				'key'          => 'field_si_fi_reviews',
				'label'        => 'Reviewblokken',
				'name'         => 'footer_reviews',
				'type'         => 'repeater',
				'layout'       => 'row',
				'button_label' => 'Reviewblok toevoegen',
				'instructions' => 'De blokken onderaan met het cijfer en de sterren. Leeg = Feedback Company en Google.',
				'sub_fields'   => array(
					array( 'key' => 'field_si_fi_rev_logo', 'label' => 'Logo', 'name' => 'logo', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail' ),
					array( 'key' => 'field_si_fi_rev_score', 'label' => 'Cijfer', 'name' => 'score', 'type' => 'text', 'instructions' => 'Bijvoorbeeld 9.5/10.' ),
					array( 'key' => 'field_si_fi_rev_aantal', 'label' => 'Aantal', 'name' => 'aantal', 'type' => 'text', 'instructions' => 'Bijvoorbeeld 300+. Komt te staan als "uit 300+ reviews".' ),
					array( 'key' => 'field_si_fi_rev_link', 'label' => 'Link naar de reviews', 'name' => 'link', 'type' => 'url' ),
				),
			),
			array(
				'key'          => 'field_si_fi_copyright',
				'label'        => 'Slotregel — eerste deel',
				'name'         => 'footer_copyright',
				'type'         => 'text',
				'instructions' => 'Leeg = "© 2026 Sokkies". Let op: het jaartal verandert niet vanzelf.',
			),
			array(
				'key'          => 'field_si_fi_kvk',
				'label'        => 'KVK-nummer',
				'name'         => 'footer_kvk',
				'type'         => 'text',
				'instructions' => 'Leeg = 89538226. Alleen het nummer; "KVK:" staat er al voor.',
			),
			array(
				'key'          => 'field_si_fi_btw',
				'label'        => 'BTW-nummer',
				'name'         => 'footer_btw',
				'type'         => 'text',
				'instructions' => 'Leeg = NL865014218B01. Alleen het nummer; "BTW:" staat er al voor.',
			),
			array(
				'key'          => 'field_si_fi_legal',
				'label'        => 'Juridische links',
				'name'         => 'footer_legal',
				'type'         => 'repeater',
				'layout'       => 'table',
				'button_label' => 'Link toevoegen',
				'instructions' => 'Staan tussen de slotregel en het KVK-nummer. Leeg = Algemene voorwaarden en Cookieverklaring.',
				'sub_fields'   => array(
