		...
		'fields' => array(
			...
			array(
				...
				'sub_fields'   => array(
					...
					array( 'key' => 'field_blog_sectie_fotos', 'label' => 'Foto\x27s onder dit blok', 'name' => 'fotos', 'type' => 'gallery', 'return_format' => 'array', 'preview_size' => 'thumbnail', 'insert' => 'append', 'instructions' => 'Optioneel — een nette fotorij: één foto = volle breedte, twee = 50/50, drie = naast elkaar. De indeling hieronder bepaalt de variant met een grote eerste foto.' ),
					array( 'key' => 'field_blog_sectie_fotos_indeling', 'label' => 'Indeling van de fotorij', 'name' => 'fotos_indeling', 'type' => 'button_group', 'choices' => array( 'naast_elkaar' => 'Naast elkaar', 'eerste_vol' => 'Eerste foto vol, daaronder per twee' ), 'default_value' => 'naast_elkaar', 'instructions' => '"Eerste foto vol" werkt het mooist met 3 of 5 foto\x27s: de eerste over de volle breedte, de rest in paren van 50/50.' ),
