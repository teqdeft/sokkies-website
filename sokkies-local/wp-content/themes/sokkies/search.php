    ...
    <div class="container-md">
      ...
      <?php if ( have_posts() ) : ?>
        <ul class="zr-list">
          ...
          while ( have_posts() ) :
              the_post();
              /* Eerst het stukje tekst waar het zoekwoord echt in staat —
                 anders is bij een treffer in een sectieveld niet te zien
                 waarom het resultaat er staat. Pas als dat niets oplevert
                 (bijvoorbeeld bij een titeltreffer) het gewone fragment. */
              $tekst = sokkies_zoek_fragment( get_the_ID(), $zoekterm );
              if ( '' === $tekst ) {
