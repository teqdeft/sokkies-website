         ...
         <div class="prod-top">
           ...
           <div class="prod-info">
             ...
             /* De Specificaties-link staat op een EIGEN REGEL maar nog wel
                BINNEN de laatste alinea van de beschrijving (verzoek Kulwant
                2026-08-25). Vandaar een <br> en geen eigen <p>: een eigen
                alinea zou de alineamarge erbij krijgen en te ver van de tekst
                komen te staan.
                Beschrijving is een wysiwyg en levert dus eigen <p>-blokken,
                daarom wordt de link met strrpos in de laatste </p> geschoven.
                Bewust strrpos en geen preg_replace: in de svg zitten tekens
                die in een vervangingsstring een eigen betekenis hebben. */
             ...
             echo false !== $laatste
               ? substr( $beschrijving_html, 0, $laatste ) . '<br>' . $spec_link . substr( $beschrijving_html, $laatste )
             ...
             <span class="prod-price-title">Staffelprijzen<span class="prod-price-btw"> (ex. BTW)</span><span class="prod-price-type">reguliere sokken</span></span>
...
<section class="specs-section" id="specs">
      ...
      <div class="specs-duddle-icons" aria-hidden="true">
        ...
        <img class="dubble-left" src="<?php echo esc_url( get_template_directory_uri() . "/assets/media/sock-duddle-pink-l-pdp.png" ); ?>" alt="">
      </div>
    ...
    <section class="cards-suggestion">
      <div class="container">
        ...
        <div class="suggestion-nav">
          <button class="suggestion-prev" aria-label="Vorige">
          ...
          <button class="suggestion-next" aria-label="Volgende">
          <svg xmlns="http://www.w3.org/2000/svg" width="12.199" height="9.39" viewBox="0 0 12.199 9.39">
