...
$std_rijen = array(
	...
	array( 'label' => 'Badstof zool', 'waarden' => array( array( 'tekst' => '' ), array( 'tekst' => '' ), array( 'tekst' => '' ), array( 'tekst' => '' ), array( 'tekst' => '' ) ) ),
);
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td<?php echo 0 === $i % 2 ? ' class="is-featured"' : ''; ?>>
                      <?php if ( '' === trim( (string) $waarde ) ) : ?><svg id="check_2" data-name="check 2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">                           <circle id="Ellipse_15" data-name="Ellipse 15" cx="15" cy="15" r="15" fill="#1dd665"/>                           <g id="check" transform="translate(9 11)">                               <path id="Path_210" data-name="Path 210" d="M110.16,670.539l3.6,3.6,8-8" transform="translate(-110.16 -666.138)" fill="none" stroke="#fff" stroke-linecap="round" stroke-width="1.5"/>                           </g>                           </svg><?php else : echo esc_html( $waarde ); endif; ?>
                  </td>
                  <?php endforeach; ?>
                </tr>
                <?php endforeach; ?>
