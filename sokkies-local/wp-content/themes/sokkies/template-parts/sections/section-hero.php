          ...
          <div class="container">
            ...
            <div class="rating-outer">
              ...
              <div class="rating-info">
                ...
                <div class="rating-info-bottom">
                   <a href="<?php echo esc_url( sokkies_reviews_url() ); ?>" target="_blank" rel="noopener">uit <?php echo esc_html( sokkies_optie( 'review_aantal', '450+' ) ); ?> reviews</a>
                </div>
              </div>
            ...
            <div class="banner-bottom-info">
              <svg xmlns="http://www.w3.org/2000/svg" width="12.199" height="9.39" viewBox="0 0 12.199 9.39">
                <g id="arrow_1" data-name="arrow 1" transform="translate(0.5 0.683)">
